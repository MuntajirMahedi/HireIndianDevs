...
const faqs = [
  ...
  ["What is the standard hourly rate?", "The standard rate starts from $25 per hour. This applies to most development roles including web, mobile, and backend engineers."],
  ["Are your developers junior or senior level?", "We provide mid to senior-level developers with real project experience. Even starting from $25 per hour, the focus is on quality and production-level engineering."],
  ...
  ["Do you provide maintenance after launch?", "Yes, you can continue to hire Indian developers for ongoing maintenance, updates, and feature improvements starting from $25 per hour."],
  ...
  ["Do you offer fixed-price development?", "Yes, for projects with clearly defined requirements, we provide fixed pricing based on estimated hours starting from $25 per hour."],
  ...
  ["Why hire from your platform?", "Because you get skilled engineers, transparent pricing starting from $25 per hour, flexible hiring models, and scalable solutions built for growth."],
];
