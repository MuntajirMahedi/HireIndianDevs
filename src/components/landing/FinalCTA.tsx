...
export const FinalCTA = () => (
  <section className="bg-primary text-primary-foreground">
    <ScrollReveal className="container-tight py-20 md:py-28 text-center">
      <h2 className="mx-auto max-w-3xl text-display-lg">
        Hire Indian Developers and <span className="text-accent">Start Building Today</span>.
      </h2>
      <p className="mx-auto mt-5 max-w-2xl text-base text-primary-foreground/70 md:text-lg">
        Get access to experienced engineers who understand product development from start to finish. Starting from $25 per hour, build, scale, and support your product with confidence.
      </p>
      <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
        <Button asChild size="lg" className="h-12 bg-accent px-6 text-base text-accent-foreground hover:bg-accent/90">
          <a href="#contact">Hire Developers Now <ArrowRight className="ml-1 h-4 w-4" /></a>
        </Button>
        <Button
          asChild
          size="lg"
